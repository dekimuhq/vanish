...
<!-- LIVE:BEGIN -->
**Repo:** dekimuhq/vanish (PRIVATE) · `main` at `440bf83` (ics+escalation, deployed) · **branch `feat/a11y-launch-gate` (`2b36fe3`) built + gated green, NOT merged** — merge + push to `main` auto-deploys to vanish.cat (founder confirm before deploy). HANDOFF.md is now git-tracked (was untracked).
