...
export const pt: Dict = {
  ...
  'countryGroup.eea': 'Espaço Económico Europeu',
  ...
  'dashboard.dueNowHeading': '⏰ A fazer agora',
  'dashboard.dueNowBody': 'Tarefas com prazo: opt-outs de brokers a repetir e prazos de cartas a reclamar:',
  'dashboard.dueLetterFallback': 'Pedido por carta',
  ...
  'settings.restorePreviewTitle': 'Pré-visualiza esta cópia antes de restaurar',
  'settings.restorePreviewWarn': 'Restaurar substitui tudo o que existe agora neste dispositivo.',
  'settings.restoreNow': 'Agora',
  'settings.restoreBackup': 'Cópia',
  'settings.restoreActions': 'Ações concluídas',
  'settings.restoreLetters': 'Cartas registadas',
