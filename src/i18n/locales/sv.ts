...
export const sv: Dict = {
  ...
  'countryGroup.eea': 'Europeiska ekonomiska samarbetsområdet',
  ...
  'dashboard.dueNowHeading': '⏰ Att göra nu',
  'dashboard.dueNowBody': 'Tidskänsliga uppgifter: mäklar-avregistreringar att göra om och svarsfrister att följa upp:',
  'dashboard.dueLetterFallback': 'Brevbegäran',
  ...
  'settings.restorePreviewTitle': 'Förhandsgranska den här säkerhetskopian innan du återställer',
  'settings.restorePreviewWarn': 'Återställning ersätter allt som finns på den här enheten.',
  'settings.restoreNow': 'Nu',
  'settings.restoreBackup': 'Kopia',
  'settings.restoreActions': 'Slutförda åtgärder',
  'settings.restoreLetters': 'Spårade brev',
  'settings.restoreLang': 'Språk',
