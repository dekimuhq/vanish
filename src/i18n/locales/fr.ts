...
export const fr: Dict = {
  ...
  'countryGroup.eea': 'Espace économique européen',
  ...
  'dashboard.dueNowHeading': '⏰ À faire maintenant',
  'dashboard.dueNowBody': 'Tâches urgentes : opt-outs de courtiers à refaire et délais de courriers à relancer :',
  'dashboard.dueLetterFallback': 'Demande par courrier',
  ...
  'settings.restorePreviewTitle': 'Prévisualisez cette sauvegarde avant de restaurer',
  'settings.restorePreviewWarn': 'La restauration remplace tout ce qui se trouve actuellement sur cet appareil.',
  'settings.restoreNow': 'Actuel',
  'settings.restoreBackup': 'Sauvegarde',
  'settings.restoreActions': 'Actions terminées',
  'settings.restoreLetters': 'Courriers suivis',
  'settings.restoreLang': 'Langue',
