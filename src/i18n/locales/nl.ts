...
export const nl: Dict = {
  ...
  'countryGroup.eea': 'Europese Economische Ruimte',
  ...
  'dashboard.dueNowHeading': '⏰ Nu te doen',
  'dashboard.dueNowBody': 'Tijdgevoelige taken: broker-opt-outs opnieuw doen en brieftermijnen opvolgen:',
  'dashboard.dueLetterFallback': 'Briefverzoek',
  ...
  'settings.restorePreviewTitle': 'Bekijk deze back-up voordat je herstelt',
  'settings.restorePreviewWarn': 'Herstellen vervangt alles wat nu op dit apparaat staat.',
  'settings.restoreNow': 'Nu',
  'settings.restoreBackup': 'Back-up',
  'settings.restoreActions': 'Voltooide acties',
  'settings.restoreLetters': 'Gevolgde brieven',
  'settings.restoreLang': 'Taal',
  'settings.restoreProfile': 'Profiel',
