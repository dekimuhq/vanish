...
export const en = {
  ...
  'countryGroup.eea': 'European Economic Area',
  ...
  'dashboard.dueNowHeading': '⏰ Due now',
  'dashboard.dueNowBody': 'Time-sensitive items — broker opt-outs to redo and letter deadlines to chase:',
  'dashboard.dueLetterFallback': 'Letter request',
  ...
  'settings.restorePreviewTitle': 'Preview this backup before restoring',
  'settings.restorePreviewWarn': 'Restoring replaces everything currently on this device.',
  'settings.restoreNow': 'Now',
  'settings.restoreBackup': 'Backup',
  'settings.restoreActions': 'Completed actions',
  'settings.restoreLetters': 'Tracked letters',
  'settings.restoreLang': 'Language',
  'settings.restoreProfile': 'Profile',
  'settings.restoreApply': 'Replace my data',
  'settings.restoreNoProfile': 'Not set',
  'settings.importErr': '✗ Could not read that file.',

  'settings.scanTitle': '🔍 Scan results',
  'settings.scanBody':
    'Import exposure findings from a vanish-recon scan report to annotate your plan with real-world matches.',
  'settings.scanImportCta': '↥ Import scan results',
  'settings.scanImportErr': 'That file isn’t a valid scan.',
  'settings.scanSummary': '{count} exposure(s) found',
  'settings.scanSummaryUnverified': '{count} exposure(s) found (unverified file)',
  'settings.scanApply': 'Apply',
  'settings.scanImportOk': '✓ Scan imported.',
  'settings.scanNote':
    'Generated by vanish-recon on your own machine. Import never sends anything — it only reads the file you choose.',
