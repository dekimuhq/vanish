...
export const de: Dict = {
  ...
  'letters.tracked.addToCalendar': '📅 Fristen in den Kalender übernehmen',
  'letters.tracked.downloadComplaint': '↓ Beschwerde herunterladen',
  'letters.tracked.lodgeAt': 'Bei {authority} einreichen ↗',
  'letters.tracked.markEscalated': 'Als eskaliert markieren',
  'letters.tracked.overdueComplaint': 'Frist überschritten — unten steht eine fertige Beschwerde an deine Aufsichtsbehörde, bereit zum Absenden.',
